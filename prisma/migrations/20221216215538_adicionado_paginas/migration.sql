...
-- AddForeignKey
ALTER TABLE `Page` ADD CONSTRAINT `Page_worldId_fkey` FOREIGN KEY (`worldId`) REFERENCES `World`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
