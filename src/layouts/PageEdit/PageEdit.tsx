        ...
        <Allotment.Pane>
          ...
          >
            ...
            <div className='w-full max-w-7xl flex flex-col pt-28'>
              {/* content */}
              <div
                className='flex p-4 flex-col min-h-screen relative items-center w-full rounded-2xl bg-neutral-900 z-10 border-2 border-neutral-600 pb-48 transition-all duration-500 ease-in-out'
                style={{
...
function Scrollable(props:
  ...
  return (
    ...
    >
      ...
      >
        <div
          className='w-full h-full relative flex flex-col bg-neutral-950 justify-start items-center transition-all duration-500 ease-in-out'
          style={{
